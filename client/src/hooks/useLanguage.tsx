...
const translations = {
  ru: {
    ...
    'contact.form.phone.placeholder': 'Введите ваш телефон',
    'contact.form.message': 'Сообщение',
    'contact.form.message.placeholder': 'Расскажите о ваших потребностях в аренде велосипеда...',
    'contact.form.submit': 'Отправить заявку',
    'contact.form.sending': 'Отправка...',
    'contact.info.title': 'Контактная информация',
    'contact.info.address.title': 'Адрес',
    'contact.info.address': 'Zygmunta Krasińskiego 28, 50-450 Wrocław',
    'contact.info.phone': '800 922 508',
    'contact.info.telegram': '@BaitEb1ke',
  ...
  en: {
    ...
    'contact.form.message.placeholder': 'Tell us about your bike rental needs...',
